...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dept` VALUES (100, 0, '0', '究本科技', 0, '无', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
INSERT INTO `sys_dept` VALUES (101, 100, '0,100', '究本上海', 1, '无', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
INSERT INTO `sys_dept` VALUES (103, 101, '0,100,101', '研发部门', 1, '无', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
INSERT INTO `sys_dept` VALUES (104, 101, '0,100,101', '市场部门', 2, '无', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
INSERT INTO `sys_dept` VALUES (106, 101, '0,100,101', '财务部门', 4, '无', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
INSERT INTO `sys_dept` VALUES (109, 101, '0,100,102', '财务部门', 2, '无', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
COMMIT;
...
INSERT INTO `sys_menu` VALUES (101, '权限组管理', 1, 2, '/system/role', '', 'C', '0', 'system:role:view', 'fa fa-user-secret', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '角色管理菜单');
...
INSERT INTO `sys_menu` VALUES (104, '角色管理', 1, 5, '/system/post', '', 'C', '0', 'system:post:view', 'fa fa-address-card-o', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '岗位管理菜单');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';

-- ----------------------------
-- Records of sys_oper_log
-- ----------------------------
BEGIN;
INSERT INTO `sys_oper_log` VALUES (1, '操作日志', 9, 'com.ruoyi.web.controller.monitor.SysOperlogController.clean()', 'POST', 1, 'wangyuliang', '研发部门', '/monitor/operlog/clean', '127.0.0.1', '内网IP', NULL, '{\n  \"msg\" : \"操作成功\",\n  \"code\" : 0\n}', 0, NULL, '2020-10-14 15:44:46');
INSERT INTO `sys_oper_log` VALUES (2, '用户管理', 1, 'com.ruoyi.web.controller.system.SysUserController.addSave()', 'POST', 1, 'wangyuliang', '研发部门', '/system/user/add', '127.0.0.1', '内网IP', '{\"deptId\":[\"103\"],\"userName\":[\"汪桢懿\"],\"deptName\":[\"研发部门\"],\"phonenumber\":[\"13301834548\"],\"email\":[\"zhenyi_wang@adfontes.com.cn\"],\"loginName\":[\" wangzhenyi\"],\"sex\":[\"0\"],\"role\":[\"101\"],\"remark\":[\"\"],\"status\":[\"0\"],\"roleIds\":[\"101\"],\"postIds\":[\"\"]}', '{\n  \"msg\" : \"操作成功\",\n  \"code\" : 0\n}', 0, NULL, '2020-10-14 15:58:59');
INSERT INTO `sys_oper_log` VALUES (3, '参数管理', 9, 'com.ruoyi.web.controller.system.SysConfigController.clearCache()', 'GET', 1, 'wangyuliang', '研发部门', '/system/config/clearCache', '127.0.0.1', '内网IP', NULL, '{\n  \"msg\" : \"操作成功\",\n  \"code\" : 0\n}', 0, NULL, '2020-10-15 10:24:07');
COMMIT;
...
INSERT INTO `sys_post` VALUES (4, 'user', '员工', 4, '0', 'admin', '2018-03-16 11:33:00', 'admin', '2020-10-14 14:54:19', '');
COMMIT;
...
INSERT INTO `sys_role` VALUES (100, '系统研发', 'DEV_ENG', 3, '1', '0', '0', 'admin', '2020-10-14 14:58:23', 'admin', '2020-10-14 14:59:22', '系统开发工程师等');
INSERT INTO `sys_role` VALUES (101, '管理员', 'ADMIN_LIMIT', 4, '1', '0', '0', 'admin', '2020-10-14 15:02:04', '', NULL, '普通管理员');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '超级管理员', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '管理员');
INSERT INTO `sys_user` VALUES (2, 105, 'ry', 'demo', '00', 'ry@qq.com', '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '测试员');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_online` VALUES ('1eb1639e-2917-46c5-be8f-7c80c54a2bdd', 'wangyuliang', '研发部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', 'on_line', '2020-10-15 10:21:30', '2020-10-15 10:23:48', 1800000);
COMMIT;
